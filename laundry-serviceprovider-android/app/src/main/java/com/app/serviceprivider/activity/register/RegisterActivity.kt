package com.app.serviceprivider.ui.activity.register
...
//                sendIntent()
    ...
    private fun onSignUpSuccess(response: LoginResponse) {
       ...
       /* SharedPreferenceWriter.getInstance(this@SignUpActivity)
            .writeStringValue(SharedPreferenceKey.ACCESS_TOKEN, response.response!!.accessToken.toString())

        SharedPreferenceWriter.getInstance(this@SignUpActivity)
            .writeStringValue(SharedPreferenceKey.EMAIL, response.response!!.email.toString())

        SharedPreferenceWriter.getInstance(this@SignUpActivity)
            .writeStringValue(SharedPreferenceKey.MOBILE_NUMBER, response.response!!.accessToken.toString())
